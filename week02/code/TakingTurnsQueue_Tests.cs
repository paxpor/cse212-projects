...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns were not being re-added to the queue as required.
    ...
    // Defect(s) Found: People with negative turns were not being re-added to the queue as required.
